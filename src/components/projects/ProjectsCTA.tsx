...
export const ProjectsCTA: React.FC<ProjectsCTAProps> = ({ onNavigate }) => {
  ...
  return (
    <section id="projects-cta" className="py-20 sm:py-24 bg-[#070E1B] border-t border-slate-800 relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 relative z-10 text-center">
        ...
        {/* Heading strictly according to prompt */}
        ...
        <p className="text-sm sm:text-base text-slate-300 leading-relaxed max-w-2xl mx-auto mb-8">
          Discuss your project requirements with AUREXON and explore the appropriate construction, engineering, project management or property development approach.
        </p>

        {/* Action Buttons strictly according to prompt */}
        ...
        {/* Bottom Corporate Accountability */}
        <div className="mt-8 flex items-center justify-center gap-2 text-xs font-mono text-slate-400">
          ...
          <span>
            {COMPANY_DETAILS.legalName} • RC: {COMPANY_DETAILS.rcNumber}
          </span>
        </div>
      </div>
    </section>
