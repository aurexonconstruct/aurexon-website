...
import { ChevronRight, ShieldCheck, ArrowRight, FolderKanban, Sparkles } from 'lucide-react';
...
export const ProjectsHero: React.FC<ProjectsHeroProps> = ({ onNavigate }) => {
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 relative z-10">
        ...
        <div className="max-w-4xl space-y-6">
          {/* Eyebrow & Corporate Identity Badge */}
          ...
          <h1 className="font-display text-3xl sm:text-5xl lg:text-6xl font-extrabold tracking-tight text-white leading-tight uppercase">
            PLANNING TODAY.<br />
            <span className="text-[#C5A869]">BUILDING FOR TOMORROW.</span>
          </h1>
          ...
          <p className="text-base sm:text-lg text-slate-300 leading-relaxed max-w-3xl font-normal">
            Explore the framework through which AUREXON presents projects across construction, engineering and property development. Project information is presented according to verified project records and approved corporate content.
          </p>

          {/* Discreet Status Label & Supporting Text */}
          <div className="p-4 bg-[#0B1528] border border-slate-800 rounded-xs flex items-start gap-3.5 max-w-2xl">
            <div className="p-1.5 bg-[#C5A869]/15 border border-[#C5A869]/30 rounded-xs text-[#C5A869] shrink-0 mt-0.5">
              <Sparkles className="w-4 h-4" />
            </div>
            <div className="space-y-1 text-xs">
              <div className="flex items-center gap-2">
                <span className="font-mono text-[10px] font-bold text-[#C5A869] uppercase tracking-[0.18em]">
                  PORTFOLIO DEVELOPING
                </span>
                <span className="h-1.5 w-1.5 rounded-full bg-[#C5A869] animate-pulse" />
              </div>
              <p className="text-slate-400 font-sans leading-relaxed">
                AUREXON's public project portfolio will expand as project information is formally approved for publication.
              </p>
            </div>
          </div>
